...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Rocco Santini.</h2>;
  ...
  const four = (
    <>
      <p>
        ...
        quality in all my projects.
      </p>
    </>
  );
  const five = (
    <a className="email-link" href="mailto:rocco83dev@gmail.com" target="_blank" rel="noreferrer">
      Get In Touch
    </a>
  );
